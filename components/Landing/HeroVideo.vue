...
<template>
    <section class="relative min-h-screen w-full flex items-center justify-center overflow-hidden">
        ...
        <div class="absolute inset-0">
            <video class="w-full h-full object-cover" src="/assets/images/templates/demo_video.mp4" autoplay muted loop
                playsinline></video>
        </div>

        <!-- Dark gradient overlay -->
        <div class="absolute inset-0 bg-gradient-to-br from-gray-900/80 via-stone-800/75 to-neutral-800/80"></div>
        ...
        <div class="container mx-auto px-4 sm:px-6 relative z-10">
            <div class="max-w-5xl mx-auto flex flex-col items-center">
                ...
                <p
                    ...
                    Professional wedding website designs that tell your unique story and create a seamless experience
                    for you and
                    your guests.
                </p>
