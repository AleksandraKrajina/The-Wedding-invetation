              ...
              <div 
                ...
                <div class="relative group">
                  ...
                  <div 
                    ...
                    <span class="opacity-0 group-hover:opacity-100 text-white bg-black bg-opacity-50 px-2 py-1 rounded text-sm">
                      Manage
                    </span>
                  </div>
                </div>
                <div class="mt-2 flex flex-wrap justify-center gap-1">
                  <div v-for="(guest, index) in table.guests.slice(0, 3)" 
                       :key="index"
                       class="w-2 h-2 rounded-full bg-gray-400">
                  </div>
                  <div v-if="table.guests.length > 3" 
        ...
        <div v-if="selectedTable" class="bg-white p-6 rounded-lg shadow-sm">
          ...
          <div class="space-y-4">
            <div>
              ...
              <div class="space-y-2">
                <div v-for="guest in selectedTable.guests" 
                     :key="guest.name"
                  ...
                  <button 
                    @click="removeGuest(selectedTable, guest)"
            ...
            <button 
              v-if="selectedTable.assigned < selectedTable.capacity"
              @click="showGuestSelector = true"
      ...
      <div class="bg-white p-6 rounded-lg w-96">
        ...
        <div class="space-y-4">
          ...
          <div class="flex justify-end gap-2 mt-6">
            <button 
              @click="isAddingTable = false"
              class="px-4 py-2 text-gray-600 hover:bg-gray-100 rounded">
              Cancel
            </button>
            <button 
              @click="addTable"
              class="px-4 py-2 bg-[#C8A898] text-white rounded hover:bg-[#bd7a59]">
              Add Table
            </button>
          </div>
        </div>
    ...
    <div v-if="showGuestSelector" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
      <div class="bg-white p-6 rounded-lg w-96">
        ...
        <div class="max-h-96 overflow-y-auto">
          <div v-for="guest in unassignedGuests" 
               :key="guest.name"
