...
<template>
  <section id="brideGroom" ref="sectionRef"
    ...
    <div class="w-full h-auto md:h-full">
      <NuxtImg src="/assets/images/templates/bride.jpg" alt="Bride" class="w-full h-full object-cover" />
    </div>
    ...
    <div class="w-full h-auto md:h-full md:hidden lg:hidden">
      <NuxtImg src="/assets/images/templates/groom.jpg" alt="Groom" class="w-full h-full object-cover" />
    </div>
