...
<template>
  <section id="home" ref="section"
    ...
    <div ref="names" class="h-auto lg:pt-1 lg:mt-2 md:pt-0 md:mt-0 flex flex-col items-center z-10">
      <h1 ref="bride" class="text-6xl md:text-8xl font-bold font-bodoni text-[color:var(--text-color)]">
        Maja
      </h1>
      <h1 ref="groom" class="text-6xl md:text-8xl font-bold font-bodoni text-[color:var(--text-color)]">
        Nikola
      </h1>
    </div>
